...
public final class Location implements Model {
  ...
  public static final QueryField TIME = field("Location", "time");
  ...
  private Location(String id, Temporal.DateTime time, Double latitude, Double longitude) {
    this.id = id;
    this.time = time;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), location.getId()) &&
              ObjectsCompat.equals(getTime(), location.getTime()) &&
  ...
  public interface TimeStep {
    LatitudeStep time(Temporal.DateTime time);
  }
  ...
  public static class Builder implements TimeStep, LatitudeStep, LongitudeStep, BuildStep {
    private String id;
    ...
    @Override
     public LatitudeStep time(Temporal.DateTime time) {
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, Temporal.DateTime time, Double latitude, Double longitude) {
      super.id(id);
      super.time(time)
        .latitude(latitude)
        .longitude(longitude);
